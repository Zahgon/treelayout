...
public class AbegoTreeLayoutForNetbeansDemo {
    ...
    private static void layoutScene(GraphScene<String, String> scene, String root) {
        AbegoTreeLayoutForNetbeans<String, String> graphLayout = new AbegoTreeLayoutForNetbeans<String, String>(root, 100, 100, 50, 50, true);
        SceneLayout sceneLayout = LayoutFactory.createSceneGraphLayout(scene, graphLayout);
        sceneLayout.invokeLayoutImmediately();
    }

    private static void layoutScene_NetbeansStyle(GraphScene<String, String> scene, String root) {
